...
final class ArrayAccessorTest extends TestCase
{
    ...
    public static function provideGetBool(): array
    {
        ...
        return [
            ...
            [['key' => ' 0 '], 'key', 0, null, new WrongTypeException('key', ' 0 ', 'bool')],
            [['key' => ' 1 '], 'key', 0, null, new WrongTypeException('key', ' 1 ', 'bool')],
            [['key' => ' 2 '], 'key', 0, null, new WrongTypeException('key', ' 2 ', 'bool')],
            [['key' => ' fAlSe '], 'key', 0, null, new WrongTypeException('key', ' fAlSe ', 'bool')],
            [['key' => ' nO '], 'key', 0, null, new WrongTypeException('key', ' nO ', 'bool')],
            [['key' => ' tRuE '], 'key', 0, null, new WrongTypeException('key', ' tRuE ', 'bool')],
            [['key' => ' wRoNg '], 'key', 0, null, new WrongTypeException('key', ' wRoNg ', 'bool')],
            [['key' => ' yEs '], 'key', 0, null, new WrongTypeException('key', ' yEs ', 'bool')],
            [['key' => ''], 'key', 0, null, new WrongTypeException('key', '', 'bool')],
            [['key' => 0.0], 'key', 0, null, new WrongTypeException('key', 0.0, 'bool')],
            [['key' => 0.1], 'key', 0, null, new WrongTypeException('key', 0.1, 'bool')],
            [['key' => 0], 'key', 0, null, new WrongTypeException('key', 0, 'bool')],
            [['key' => 1.0], 'key', 0, null, new WrongTypeException('key', 1.0, 'bool')],
            [['key' => 1.2], 'key', 0, null, new WrongTypeException('key', 1.2, 'bool')],
            [['key' => 1], 'key', 0, null, new WrongTypeException('key', 1, 'bool')],
            [['key' => 2], 'key', 0, null, new WrongTypeException('key', 2, 'bool')],
            [['key' => []], 'key', 0, null, new WrongTypeException('key', [], 'bool')],
            ...
            [['key' => ' 2 '], 'key', $p, null, new WrongTypeException('key', ' 2 ', 'bool')],
            [['key' => ' fAlSe '], 'key', $p, false, null],
            [['key' => ' nO '], 'key', $p, false, null],
            [['key' => ' tRuE '], 'key', $p, true, null],
            [['key' => ' wRoNg '], 'key', $p, null, new WrongTypeException('key', ' wRoNg ', 'bool')],
            [['key' => ' yEs '], 'key', $p, true, null],
            [['key' => ''], 'key', $p, false, null],
            [['key' => 0.0], 'key', $p, null, new WrongTypeException('key', 0.0, 'bool')],
            [['key' => 0.1], 'key', $p, null, new WrongTypeException('key', 0.1, 'bool')],
            [['key' => 0], 'key', $p, false, null],
            [['key' => 1.0], 'key', $p, null, new WrongTypeException('key', 1.0, 'bool')],
            [['key' => 1.2], 'key', $p, null, new WrongTypeException('key', 1.2, 'bool')],
            [['key' => 1], 'key', $p, true, null],
            [['key' => 2], 'key', $p, null, new WrongTypeException('key', 2, 'bool')],
            [['key' => []], 'key', $p, null, new WrongTypeException('key', [], 'bool')],
            [['key' => false], 'key', $p, false, null],
    ...
    public static function provideGetBoolOptional(): array
    {
        ...
        return [
            ...
            [['key' => ' 0 '], 'key', $r, null, new WrongTypeException('key', ' 0 ', 'bool')],
            [['key' => ' 1 '], 'key', $r, null, new WrongTypeException('key', ' 1 ', 'bool')],
            [['key' => ' 2 '], 'key', $r, null, new WrongTypeException('key', ' 2 ', 'bool')],
            [['key' => ' fAlSe '], 'key', $r, null, new WrongTypeException('key', ' fAlSe ', 'bool')],
            [['key' => ' nO '], 'key', $r, null, new WrongTypeException('key', ' nO ', 'bool')],
            [['key' => ' tRuE '], 'key', $r, null, new WrongTypeException('key', ' tRuE ', 'bool')],
            [['key' => ' wRoNg '], 'key', $r, null, new WrongTypeException('key', ' wRoNg ', 'bool')],
            [['key' => ' yEs '], 'key', $r, null, new WrongTypeException('key', ' yEs ', 'bool')],
            [['key' => ''], 'key', $r, null, new WrongTypeException('key', '', 'bool')],
            [['key' => 0.0], 'key', $r, null, new WrongTypeException('key', 0.0, 'bool')],
            [['key' => 0.1], 'key', $r, null, new WrongTypeException('key', 0.1, 'bool')],
            [['key' => 0], 'key', $r, null, new WrongTypeException('key', 0, 'bool')],
            [['key' => 1.0], 'key', $r, null, new WrongTypeException('key', 1.0, 'bool')],
            [['key' => 1.2], 'key', $r, null, new WrongTypeException('key', 1.2, 'bool')],
            [['key' => 1], 'key', $r, null, new WrongTypeException('key', 1, 'bool')],
            [['key' => 2], 'key', $r, null, new WrongTypeException('key', 2, 'bool')],
            [['key' => []], 'key', $r, null, new WrongTypeException('key', [], 'bool')],
            ...
            [['key' => ' 2 '], 'key', $p | $r, null, new WrongTypeException('key', ' 2 ', 'bool')],
            [['key' => ' fAlSe '], 'key', $p | $r, false, null],
            [['key' => ' nO '], 'key', $p | $r, false, null],
            [['key' => ' tRuE '], 'key', $p | $r, true, null],
            [['key' => ' wRoNg '], 'key', $p | $r, null, new WrongTypeException('key', ' wRoNg ', 'bool')],
            [['key' => ' yEs '], 'key', $p | $r, true, null],
            [['key' => ''], 'key', $p | $r, false, null],
            [['key' => 0.0], 'key', $p | $r, null, new WrongTypeException('key', 0.0, 'bool')],
            [['key' => 0.1], 'key', $p | $r, null, new WrongTypeException('key', 0.1, 'bool')],
            [['key' => 0], 'key', $p | $r, false, null],
            [['key' => 1.0], 'key', $p | $r, null, new WrongTypeException('key', 1.0, 'bool')],
            [['key' => 1.2], 'key', $p | $r, null, new WrongTypeException('key', 1.2, 'bool')],
            [['key' => 1], 'key', $p | $r, true, null],
            [['key' => 2], 'key', $p | $r, null, new WrongTypeException('key', 2, 'bool')],
            [['key' => []], 'key', $p | $r, null, new WrongTypeException('key', [], 'bool')],
            [['key' => false], 'key', $p | $r, false, null],
            [['key' => null], 'key', $p | $r, null, null],
            [['key' => true], 'key', $p | $r, true, null],
            [[], 'key', $p | $r, null, new MissingKeyException('key')],

            [['key' => ' 0 '], 'key', $n, null, new WrongTypeException('key', ' 0 ', 'bool')],
            [['key' => ' 1 '], 'key', $n, null, new WrongTypeException('key', ' 1 ', 'bool')],
            [['key' => ' 2 '], 'key', $n, null, new WrongTypeException('key', ' 2 ', 'bool')],
            [['key' => ' fAlSe '], 'key', $n, null, new WrongTypeException('key', ' fAlSe ', 'bool')],
            [['key' => ' nO '], 'key', $n, null, new WrongTypeException('key', ' nO ', 'bool')],
            [['key' => ' tRuE '], 'key', $n, null, new WrongTypeException('key', ' tRuE ', 'bool')],
            [['key' => ' wRoNg '], 'key', $n, null, new WrongTypeException('key', ' wRoNg ', 'bool')],
            [['key' => ' yEs '], 'key', $n, null, new WrongTypeException('key', ' yEs ', 'bool')],
            [['key' => ''], 'key', $n, null, new WrongTypeException('key', '', 'bool')],
            [['key' => 0.0], 'key', $n, null, new WrongTypeException('key', 0.0, 'bool')],
            [['key' => 0.1], 'key', $n, null, new WrongTypeException('key', 0.1, 'bool')],
            [['key' => 0], 'key', $n, null, new WrongTypeException('key', 0, 'bool')],
            [['key' => 1.0], 'key', $n, null, new WrongTypeException('key', 1.0, 'bool')],
            [['key' => 1.2], 'key', $n, null, new WrongTypeException('key', 1.2, 'bool')],
            [['key' => 1], 'key', $n, null, new WrongTypeException('key', 1, 'bool')],
            [['key' => 2], 'key', $n, null, new WrongTypeException('key', 2, 'bool')],
            [['key' => []], 'key', $n, null, new WrongTypeException('key', [], 'bool')],
            ...
            [['key' => ' 0 '], 'key', $n | $r, null, new WrongTypeException('key', ' 0 ', 'bool')],
            [['key' => ' 1 '], 'key', $n | $r, null, new WrongTypeException('key', ' 1 ', 'bool')],
            [['key' => ' 2 '], 'key', $n | $r, null, new WrongTypeException('key', ' 2 ', 'bool')],
            [['key' => ' fAlSe '], 'key', $n | $r, null, new WrongTypeException('key', ' fAlSe ', 'bool')],
            [['key' => ' nO '], 'key', $n | $r, null, new WrongTypeException('key', ' nO ', 'bool')],
            [['key' => ' tRuE '], 'key', $n | $r, null, new WrongTypeException('key', ' tRuE ', 'bool')],
            [['key' => ' wRoNg '], 'key', $n | $r, null, new WrongTypeException('key', ' wRoNg ', 'bool')],
            [['key' => ' yEs '], 'key', $n | $r, null, new WrongTypeException('key', ' yEs ', 'bool')],
            [['key' => ''], 'key', $n | $r, null, new WrongTypeException('key', '', 'bool')],
            [['key' => 0.0], 'key', $n | $r, null, new WrongTypeException('key', 0.0, 'bool')],
            [['key' => 0.1], 'key', $n | $r, null, new WrongTypeException('key', 0.1, 'bool')],
            [['key' => 0], 'key', $n | $r, null, new WrongTypeException('key', 0, 'bool')],
            [['key' => 1.0], 'key', $n | $r, null, new WrongTypeException('key', 1.0, 'bool')],
            [['key' => 1.2], 'key', $n | $r, null, new WrongTypeException('key', 1.2, 'bool')],
            [['key' => 1], 'key', $n | $r, null, new WrongTypeException('key', 1, 'bool')],
            [['key' => 2], 'key', $n | $r, null, new WrongTypeException('key', 2, 'bool')],
            [['key' => []], 'key', $n | $r, null, new WrongTypeException('key', [], 'bool')],
            ...
            [['key' => ' 2 '], 'key', $n | $p, null, new WrongTypeException('key', ' 2 ', 'bool')],
            [['key' => ' fAlSe '], 'key', $n | $p, false, null],
            [['key' => ' nO '], 'key', $n | $p, false, null],
            [['key' => ' tRuE '], 'key', $n | $p, true, null],
            [['key' => ' wRoNg '], 'key', $n | $p, null, new WrongTypeException('key', ' wRoNg ', 'bool')],
            [['key' => ' yEs '], 'key', $n | $p, true, null],
            [['key' => ''], 'key', $n | $p, false, null],
            [['key' => 0.0], 'key', $n | $p, null, new WrongTypeException('key', 0.0, 'bool')],
            [['key' => 0.1], 'key', $n | $p, null, new WrongTypeException('key', 0.1, 'bool')],
            [['key' => 0], 'key', $n | $p, false, null],
            [['key' => 1.0], 'key', $n | $p, null, new WrongTypeException('key', 1.0, 'bool')],
            [['key' => 1.2], 'key', $n | $p, null, new WrongTypeException('key', 1.2, 'bool')],
            [['key' => 1], 'key', $n | $p, true, null],
            [['key' => 2], 'key', $n | $p, null, new WrongTypeException('key', 2, 'bool')],
            [['key' => []], 'key', $n | $p, null, new WrongTypeException('key', [], 'bool')],
            [['key' => false], 'key', $n | $p, false, null],
            ...
            [['key' => ' 2 '], 'key', $n | $p | $r, null, new WrongTypeException('key', ' 2 ', 'bool')],
            [['key' => ' fAlSe '], 'key', $n | $p | $r, false, null],
            [['key' => ' nO '], 'key', $n | $p | $r, false, null],
            [['key' => ' tRuE '], 'key', $n | $p | $r, true, null],
            [['key' => ' wRoNg '], 'key', $n | $p | $r, null, new WrongTypeException('key', ' wRoNg ', 'bool')],
            [['key' => ' yEs '], 'key', $n | $p | $r, true, null],
            [['key' => ''], 'key', $n | $p | $r, false, null],
            [['key' => 0.0], 'key', $n | $p | $r, null, new WrongTypeException('key', 0.0, 'bool')],
            [['key' => 0.1], 'key', $n | $p | $r, null, new WrongTypeException('key', 0.1, 'bool')],
            [['key' => 0], 'key', $n | $p | $r, false, null],
            [['key' => 1.0], 'key', $n | $p | $r, null, new WrongTypeException('key', 1.0, 'bool')],
            [['key' => 1.2], 'key', $n | $p | $r, null, new WrongTypeException('key', 1.2, 'bool')],
            [['key' => 1], 'key', $n | $p | $r, true, null],
            [['key' => 2], 'key', $n | $p | $r, null, new WrongTypeException('key', 2, 'bool')],
            [['key' => []], 'key', $n | $p | $r, null, new WrongTypeException('key', [], 'bool')],
            [['key' => false], 'key', $n | $p | $r, false, null],
    ...
    public function testGetBool(
        ...
        self::assertSame($expected, (new ArrayAccessor($data))->getBool($key, $flags));
    }

    #[DataProvider('provideGetBoolOptional')]
    public function testGetBoolOptional(
        array $data,
        int|string $key,
        int $flags,
        ?bool $expected,
        ...
        self::assertSame($expected, (new ArrayAccessor($data))->getBoolOptional($key, $flags));
    }
